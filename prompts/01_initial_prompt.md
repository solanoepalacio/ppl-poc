<context>
    ...
    <session_goal>
        This session goal is to generate a specification files (/spec/*) for this PoC that can be used to plan the work to be carried out by autonomous agents.
        The development plan will be generated on a following session.
    </session_goal>
    <context_for_poc>
    ### Overview
...
<user_prompt>
I've drafted out the layout of spec.md.
Let's go over the design of this system from top to bottom.
Starting from a broad overview of the system and progressively narrowing it down to the details of the different components.
