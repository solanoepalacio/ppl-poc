...
Defines how the system aggregates per-product quantities to produce for a given day from qualifying orders, and how the back office surfaces these production totals to the manager.
